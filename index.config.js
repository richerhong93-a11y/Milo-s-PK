...
var index_config_default = {
 ...
 t4: {list: [
    ...
    {name: "[备用] 瓜子影视",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_gzapp.txt"},
    {name: "荐片",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_jianpian.txt"},
    {name: "乌云影视",
    ...
    {name: "1080在线",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_zxzj.txt"},
    {name: "人人视频",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_rrsp.txt"},
    {name: "韩剧看看",
    ...
    {name: "iKanBot",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_iKanBot.txt"},
    {name: "河马短剧",
     address: "https://cdn.jsdelivr.net/gh/YYDS678/uzVideo-extensions@main/vod/js/Zhi_hmdj.txt"},
    {name: "E-ACG",
    ...
    {name: "极速",
     address: "https://jszyapi.com/api.php/provide/vod/from/jsm3u8/at/json"},
    {name: "暴风",
     address: "http://by.bfzyapi.com/api.php/provide/vod"},
    {name: "电影天堂",
     address: "http://dyttzyw.com/api.php/provide/vod/?ac=list"},
    {name: "豆瓣",
     address: "https://caiji.doubanzy.cc/api.php/provide/vod/at/josn"},
    {name: "茅台",
     address: "https://caiji.maotaizy.cc/api.php/provide/vod/from/mtm3u8/at/josn"},
    {name: "如意",
     address: "http://cj.rycjapi.com/api.php/provide/vod/?ac=list"},
    {name: "量子",
     address: "https://cj.lziapi.com/api.php/provide/vod/?ac=list"},
    {name: "卧龙",
     address: "https://collect.wolongzy.cc/api.php/provide/vod"},
    {name: "360",
     address: "https://360zyzz.com/api.php/provide/vod"},
    {name: "U酷",
     address: "https://api.ukuapi88.com/api.php/provide/vod/?ac=list"},
    {name: "天涯",
     address: "https://tyyszyapi.com/api.php/provide/vod/?ac=list"},
    {name: "无尽",
     address: "https://api.wujinapi.me/api.php/provide/vod/?ac=list"},
    {name: "iQIYI",
     address: "https://iqiyizyapi.com/api.php/provide/vod"},
    {name: "ikun",
     address: "https://ikunzyapi.com/api.php/provide/vod/from/ikm3u8/at/json"},
    {name: "魔都",
     address: "https://www.mdzyapi.com/api.php/provide/vod/?ac=list"},
    {name: "百度云",
     address: "https://api.apibdzy.com/api.php/provide/vod/?ac=list"},
    {name: "闪电",
     address: "https://xsd.sdzyapi.com/api.php/provide/vod/?ac=list"},
    {name: "红牛",
     address: "https://www.hongniuzy2.com/api.php/provide/vod/from/hnm3u8/at/josn"},
    {name: "光速",
     address: "https://api.guangsuapi.com/api.php/provide/vod/from/gsm3u8"},
    {name: "新浪",
     address: "https://api.xinlangapi.com/xinlangapi.php/provide/vod/from/xlm3u8"},
    {name: "快车",
     address: "https://caiji.kuaichezy.org/api.php/provide/vod/?ac=list"},
    {name: "金鹰",
     address: "https://jyzyapi.com/provide/vod/from/jinyingm3u8/at/json"},
    {name: "猫眼",
     address: "https://api.maoyanapi.top/api.php/provide/vod"},
    {name: "旺旺",
     address: "https://api.wwzy.tv/api.php/provide/vod/?ac=list"},
    {name: "虎牙",
     address: "https://www.huyaapi.com/api.php/provide/vod/from/hym3u8/at/json"},
    {name: "豪华",
     address: "https://hhzyapi.com/api.php/provide/vod/from/hhm3u8/at/json"},
    {name: "速播",
     address: "https://subocj.com/api.php/provide/vod/from/subm3u8/at/json"},
    {name: "非凡",
     address: "https://ffzy1.tv/api.php/provide/vod"},
    {name: "樱花",
     address: "https://m3u8.apiyhzy.com/api.php/provide/vod/?ac=list"},
    {name: "优质",
     address: "http://api.yzzy-api.com/inc/apijson.php?ac=list"},
    {name: "鸭鸭",
     address: "https://cj.yayazy.net/api.php/provide/vod/?ac=list"},
    {name: "牛牛",
    ...
    {name: "OK",
     address: "https://api.okzyw.net/api.php/provide/vod/?ac=list"},
    {name: "索尼",
     address: "https://suoniapi.com/api.php/provide/vod/?ac=list"},
    {name: "ok吊炸天",
